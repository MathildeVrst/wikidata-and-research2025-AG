...
Let me now introduce the case study behind today’s reflections — the *Anthologia Graeca* project, a collaborative digital edition of the *Greek Anthology*.
...
The project was launched in 2014 by Marcello Vitali-Rosati, as part of his Canada Research Chair in Digital Textualities, with collaborators including Christian Raschle and Elsa Bouchard. I’ve been the project coordinator since 2021. 

Supported by several grants from the Social Sciences and Humanities Research Council of Canada, it brings together a wide network of scholars, developers, and students — from the University of Montreal, the University of Naples, and even high school students from Bari. Institutional partners include the Interuniversity Research Centre on the Digital Humanities, the Research Group on Scholarly Editions in a Digital Context, Perseus, and the Heidelberg University Library.
...
2. Cities, about which the epigram is about;
...
To do so, we began by exporting all our names into a spreadsheet. That gave us a first overview of inconsistencies — duplicates, spelling variants, ambiguous attributions. We added their names in Latin, Ancient Greek, English, French, and Italian.
...
## Dionysos (uncertain attribution for common names) 
...
## Gain for our platform and for wikidata 
...
## Other keywords and future work 
